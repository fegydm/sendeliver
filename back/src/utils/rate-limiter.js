...
var RateLimiter = /** @class */ (function () {
    function RateLimiter(refillRate, interval) {
    ...
    RateLimiter.prototype.refill = function () {
        ...
        var newTokens = Math.floor(timePassed / this.interval) * this.refillRate;
        if (newTokens > 0) {
