...
const HomePage = ({ isDarkMode, onToggleDarkMode }: HomePageProps) => {
  ...
  return (
    <div
      className={`min-w-[320px] ${isDarkMode ? "dark bg-gray-900 text-white" : "bg-white text-gray-900"}`}
    >
      ...
      <div className="pt-16">
        ...
        <main className="container mx-auto px-4 py-8">
          ...
          <div className="mt-8 grid grid-cols-1 md:grid-cols-3 gap-6">
            <div
              className={`p-6 rounded-lg shadow-md ${isDarkMode ? "bg-gray-800" : "bg-gray-50"}`}
            >
