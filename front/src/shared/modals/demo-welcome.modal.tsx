    ...
    >
      <div className="demo-welcome-modal">
        ...
        <div className="demo-welcome-modal__actions">
          <Button variant="secondary" onClick={onDecline}>Continue as Guest</Button>
          <Button variant="primary" onClick={onAccept}>Accept & Save Demo</Button>
        </div>
