...
import { ThemeProvider, useTheme } from "@/contexts/ThemeContext"; // Import ThemeProvider and useTheme hook
...
const AppContent: React.FC = () => {
  ...
  return (
    <div data-theme={theme}> {/* Apply data-theme attribute for CSS variables */}
      <header>
        <Navigation />
      </header>
      <main>
