...
// Updated to use useLanguageContext and proper LanguageInfo object.
...
const NavbarLanguage: React.FC = () => {
  ...
  const { currentLanguage, secondaryLanguage, changeLanguage } = useLanguageContext();
  // For convenience, destructure currentLanguage.lc.
  ...
  const groupedLanguages = useMemo(() => {
    ...
    languages.forEach(lang => {
      if (lang.lc === currentLc || lang.lc === secLc || (tertiaryLc && lang.lc === tertiaryLc)) {
    ...
    return (
      <>
        {priorityFiltered.map(lang => (
          <div 
            key={lang.id || lang.lc}
            className={`navbar-language-item ${lang.lc === currentLc ? 'navbar-language-item--primary' : ''} ${lang.lc === secLc ? 'navbar-language-item--secondary' : ''} ${tertiaryLc && lang.lc === tertiaryLc ? 'navbar-language-item--tertiary' : ''}`}
