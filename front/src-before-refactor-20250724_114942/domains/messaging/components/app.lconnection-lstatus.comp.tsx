// File: src/domains/messaging/components/app.lconnection-lstatus.comp.tsx
...
const ConnectionStatus: React.FC<ConnectionStatusProps> = ({
  ...
  const formatLatency = (latency: number): string => {
    ...
    if (latency < 150) return `${latency}ms ⚠️`;
    return `${latency}ms ❌`;
  };
          ...
          {quality && (
            <div className="quality-metrics">
              <div className="metric">
                ...
                <span className="metric-value">{formatLatency(quality.latency)}</span>
              </div>
              
              <div className="metric">
                <span className="metric-label">Šírka pásma:</span>
                <span className="metric-value">{formatBandwidth(quality.bandwidth)}</span>
              </div>
              
              <div className="metric">
                <span className="metric-label">Strata paketov:</span>
              ...
              <div className="metric">
                <span className="metric-label">Typ pripojenia:</span>
                <span className="metric-value">
...
export const CompactConnectionStatus: React.FC<CompactConnectionStatusProps> = ({
  ...
  return (
    <div className={`compact-connection-status ${className}`}>
      ...
      >
        {!isConnected && <div className="disconnected-line" />}
      </div>
