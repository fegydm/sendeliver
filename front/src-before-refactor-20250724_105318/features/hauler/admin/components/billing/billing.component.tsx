// File: src/components/hauler/admin/billing/billing.component.tsx
      ...
      <motion.div className="billing__charts" initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 0.2 }}>
        <div className="chart-card">
          ...
          <ResponsiveContainer width="100%" height={250}>
            <LineChart data={mockRevenueTrend.data}><Tooltip contentStyle={{ borderRadius: '8px' }} formatter={(value: number) => formatCurrency(value)}/><Line type="monotone" dataKey="value" stroke="#4caf50" strokeWidth={2} dot={{ r: 4 }} /></LineChart>
          </ResponsiveContainer>
        </div>
        <div className="chart-card">
