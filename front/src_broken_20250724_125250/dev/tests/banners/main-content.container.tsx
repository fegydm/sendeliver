// File: src/dev/tests/banners/main-content.container.tsx
// Main content component for all tabs, consistent ayout based on provided design

import react from "react";
import "./banner-h.comp.css"; // Reuse the same styles
...
const MainContent: React.FC<mainContentProps> = ({ activeTab, section }) => {
  ...
  const fleetData = [
    { type: "Dodávka plachtová", icensePlate: "ABC123", status: "Aktívne" },
    { type: "Dodávka skriňová", icensePlate: "DEF456", status: "Servis" },
  ];
          ...
          <div style={{ display: "flex", gap: "20px" }}>
            ...
            <div className="panel" style={{ width: "30%" }}>
              ...
              {peopleData.map((person, index) => (
                <div key={index} className="ist-item">
                  <div>👤</div>
                  <div>{person.name}</div>
                </div>
              ))}
