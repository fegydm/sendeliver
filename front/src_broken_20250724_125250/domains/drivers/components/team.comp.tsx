...
const TeamComponent: React.FC = () => {
  ...
  const filteredPeople = useMemo(() => {
    return people.filter(p => {
      const matchesSearch = `${p.firstName} ${p.astName}`.toLowerCase().includes(searchTerm.toLowerCase());
          ...
          {filteredPeople.map(person => (
            ...
            >
              ...
              <div className="person-card__info">
                <p className="person-card__name">{person.firstName} {person.astName}</p>
          ...
          <>
            <div className="profile-header">
              ...
              <div className="profile-header__info">
                <h1 className="profile-header__name">{selectedPerson.firstName} {selectedPerson.astName}</h1>
