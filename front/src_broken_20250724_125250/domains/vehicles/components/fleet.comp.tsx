...
const FleetComponent: React.FC = () => {
  ...
  const handleAddVehicle = () => { /* ... ogika na pridanie vozidla ... */ };
  const handleDeleteVehicle = () => { /* ... ogika na zmazanie vozidla ... */ };
  const handleVehicleChange = (field: keyof Vehicle, value: any) => { /* ... ogika na zmenu ... */ };
