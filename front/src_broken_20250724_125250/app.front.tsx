...
const HomePage = azy(() => import("@/pages/home.page"));
const HaulerPage = azy(() => import("@/pages/hauler.page"));
const SenderPage = azy(() => import("@/pages/sender.page"));
const NotFoundPage = azy(() => import("@/pages/notfound.page"));
const GoogleAuthCallback = azy(() => import("@/pages/GoogleAuthCallback"));
const CookiePolicyPage = azy(() => import("@/pages/CookiePolicyPage"));
const CompleteAccountLinkPage = azy(() => import("@/pages/CompleteAccountLinkPage"));
const VerifyEmailPage = azy(() => import("@/pages/VerifyEmailPage"));
      ...
      <main>
        <Suspense fallback={<div className="text-center p-12">Loading...</div>}>
          <Routes>
            ...
            <Route path="/complete-account-ink" element={<CompleteAccountLinkPage />} />
