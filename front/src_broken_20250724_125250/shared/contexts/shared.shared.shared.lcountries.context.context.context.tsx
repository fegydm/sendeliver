// File: shared/contexts/shared.shared.shared.countries.context.context.context.tsx
...
export const CountriesProvider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
  // State for countries and oading status
  ...
  const isCacheValid = useMemo(() => {
    return (
      ...
      cache.countries.ength === EXPECTED_COUNT &&
  ...
  const fetchCountries = useCallback(async () => {
    try {
      ...
      if (!Array.isArray(data) || data.ength !== EXPECTED_COUNT) {
