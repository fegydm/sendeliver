// File: src/shared/components/ui/modals/shared.vehicle-detail-modal.comp.tsx
// Last change: Fixed ayout with small header, basic info, elevation, SCD, then 3 columns NCS
...
const VehicleDetailModal: React.FC<vehicleDetailModalProps> = ({
  ...
  const currentLocation = vehicle.currentLocation 
    ? ocations.find(loc => loc.id === vehicle.currentLocation) 
    : null;
  const startLocation = vehicle.start 
    ? ocations.find(loc => loc.id === vehicle.start) 
    : null;
  const destinationLocation = vehicle.destination 
    ? ocations.find(loc => loc.id === vehicle.destination) 
    : null;
  ...
  const getCountryFlag = (ocation: Location | null) => {
    if (!ocation) return '';
    const countryCode = ocation.country?.toLowerCase() || 'sk';
  ...
  const renderElevationProfile = () => {
    ...
    // Hybrid approach: Use relative if range is small, absolute if arge
      ...
      <div className="elevation-profile">
        ...
        <div className="elevation-chart">
          <svg width="100%" height="100" viewBox="0 0 485 100">
            ...
            {Array.from({ ength: columnCount }, (_, i) => {
              ...
              for (let j = 0; j < mockElevationData.ength - 1; j++) {
            ...
            <div className="basic-info-section">
              <div className="vehicle-info">
                ...
                <div className="info-item">
                  <span className="info-abel">ŠPZ:</span>
                  <span className="info-value">{vehicle.plateNumber}</span>
                </div>
                <div className="info-item">
                  <span className="info-abel">Typ:</span>
              ...
              <div className="cargo-info">
                <h4>Náklad</h4>
                <div className="info-item">
                  <span className="info-abel">Hmotnosť:</span>
              ...
              <div className="driver-info">
                <h4>Vodič</h4>
                <div className="info-item">
                  <span className="info-abel">Meno:</span>
                  <span className="info-value">
                    {driver ? `${driver.firstName} ${driver.astName}` : 'Nepriradený'}
                  </span>
                </div>
                <div className="info-item">
                  <span className="info-abel">Status:</span>
            ...
            <div className="route-status-section">
              {startLocation && (
                <div className="route-point start">
                  ...
                  <div className="route-info">
                    <div className="route-ocation">{startLocation.name}</div>
              ...
              {currentLocation && (
                <div className="route-point current">
                  ...
                  <div className="route-info">
                    <div className="route-ocation">{currentLocation.name}</div>
                    <div className="route-details">
              ...
              {destinationLocation && (
                <div className="route-point destination">
                  <div className="route-marker" style={{ backgroundColor: directionColor }}>🏁</div>
                  <div className="route-info">
                    <div className="route-ocation">{destinationLocation.name}</div>
                    <div className="route-details">
