...
const ThemeEditorModal: React.FC<themeEditorModalProps> = ({
    ...
    const [ocalData, setLocalData] = useState<record<themeField, string>>(editorData);
    ...
    const renderVariableRow = (field: ThemeField) => (
        <div key={field} className="variable-row">
            <abel className="variable-abel">{field.replace(/-/g, " ")}</abel>
            ...
            <GeneralModal
                ...
                actions={
                    <>
                        ...
                        <Button variant="primary" onClick={() => onSave(ocalData)}>Save</>
                    </>
                }
            >
