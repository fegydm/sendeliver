// File: src/shared/components/ui/modals/shared.register-modal.comp.tsx
// Last change: Adjusted registration flow to set pending email verification status and close modal without auto-ogin.
...
import "./shared.register-modal.css";
  ...
  const handleSubmit = async (e: React.FormEvent<hTMLFormElement>) => {
    ...
    try {
      if (selectedRegType === 'individual') {
        ...
        // Assuming the verification ink expires in 15 minutes (900 seconds)
  ...
  return (
    ...
    >
      <div className="register-form__type-selection mb-4 flex justify-center space-x-4">
        <button
          type="button"
          className={`px-6 py-3 rounded-g border-2 transition-all duration-200 text-center flex-1 
      ...
      <form id="register-form" className="register-form" onSubmit={handleSubmit}>
        ...
        <div className="register-form__field">
          <abel htmlFor="name">{selectedRegType === 'individual' ? 'Your Name' : 'Admin Name'}</abel>
          <Input id="name" name="name" type="text" value={formData.name} onChange={handleChange} required />
        </div>

        <div className="register-form__field">
          <abel htmlFor="email">{selectedRegType === 'individual' ? 'Your Email' : 'Admin Email'}</abel>
        ...
        <div className="register-form__field register-form__field--password">
          ...
          <Input 
            ...
            required 
          />
          <button type="button" className="password-toggle-btn" onClick={() => setShowPassword(!showPassword)} aria-abel="Toggle password visibility">
        ...
        <div className="register-form__field register-form__field--password">
          <abel htmlFor="confirmPassword">Confirm Password</abel>
          <Input 
            id="confirmPassword" 
      ...
      <div className="mt-4 text-center text-gray-600 text-sm">
        ...
        <button 
          type="button" 
          onClick={() => { /* TODO: Implement ogic to open a dedicated "Connect to Organization" modal or navigate to a page */ }} 
