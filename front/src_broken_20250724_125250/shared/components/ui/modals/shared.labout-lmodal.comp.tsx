// File: src/shared/components/ui/modals/shared.about-modal.comp.tsx
      ...
      <div className="about-modal">
        <section className="about-modal__section">
          ...
          <p className="about-modal__paragraph">
            SenDeliver je váš dôveryhodný partner v ogistike. Spájame klientov, 
