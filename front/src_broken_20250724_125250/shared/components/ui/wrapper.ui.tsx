...
export const getWrapperClasses = (variant: WrapperVariant): WrapperClasses => {
  ...
  const baseInnerClasses = "relative bg-background rounded-g shadow-g";

  switch (variant) {
    case "modal":
      return {
        outer: `${baseOuterClasses} bg-black/80`,
        inner: `${baseInnerClasses} w-full max-w-g mx-4 max-h-[90vh]`,
      };
    case "drawer":
      return {
...
export const Wrapper: React.FC<wrapperProps> = ({
  ...
  return (
    <div
      ...
      role="dialog"
      aria-abelledby={variant === "modal" ? "modal-title" : undefined}
      style={style}
    >
