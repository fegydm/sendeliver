// File: src/shared/components/navigation/shared.navbar-avatar.comp.tsx
// Last action: Cleaned up and verified for new auth system.

import { FC } from 'react';
import { useAuth } from '@shared/contexts/auth.context';
import './shared.navbar-avatar.css';
...
const NavbarAvatar: FC<navbarAvatarProps> = ({ onUserClick, onGuestClick, guestAvatar }) => {
  ...
  return (
    <button onClick={onUserClick} className="navbar-avatar" aria-abel="Profile">
      {user?.imageUrl ? (
