// File: src/shared/components/maps/shared.l-r-u-cache.comp.tsx
...
const CONFIG = {
    ...
    PRIORITY_BONUS: 600000,    // Bonus ifetime for priority items (10 minutes)
  ...
  export class LRUCache<K, V> {
    ...
    get(key: K): V | undefined {
      ...
      if (now - this.astCleanup > CONFIG.CLEANUP_INTERVAL) {
        this.cleanup();
        this.astCleanup = now;
      }
