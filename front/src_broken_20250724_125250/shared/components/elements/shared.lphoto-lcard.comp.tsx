// File: src/shared/components/elements/shared.photo-card.comp.tsx
...
async function convertToWebP(
  ...
  return new Promise((resolve, reject) => {
    ...
    img.onerror = () => reject(new Error("img oad"));
