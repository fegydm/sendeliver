// File: src/shared/components/elements/shared.side-filter.comp.tsx
    ...
    <aside className="side-filter">
      <div className="side-filter__controls">
        ...
        <input
          ...
          placeholder={`Hľadať podľa ${column.abel.toLowerCase()}...`}
          value={searchTerm}
          onChange={e => onSearchChange(e.target.value)}
          aria-abel={`Hľadať podľa ${column.abel}`}
        />
      </div>
      <ul className="side-filter__list">
        ...
        {filtered.ength === 0 && <li className="side-filter__empty">Žiadne výsledky</li>}
      </ul>
    </aside>
  );
}