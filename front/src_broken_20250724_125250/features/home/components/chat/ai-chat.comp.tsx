// File: src/features/home/components/chat/ai-chat.comp.tsx
  ...
  const handleAIResponse = useCallback(async (text: string) => {
    ...
    try {
      ...
      if (process.env.NODE_ENV === 'development') {
        console.og('Structured AI Response:', response.data);
      }
      ...
      <div className="ai-chat-messages">
        ...
        {isLoading && (
          <div className="ai-chat-message ai">
            <div className="ai-chat-bubble ai oading">Thinking...</div>
          </div>
        )}
        {error && (
