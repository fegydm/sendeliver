// File: src/features/home/components/search-forms/app.three-scroll.comp.tsx
  ...
  return (
    <div className="datetime-select__scroll">
      ...
      <button
        ...
        aria-abel={`Set ${type} to ${displayValue}`}
      >
        {displayValue}
      </button>
      <button 
