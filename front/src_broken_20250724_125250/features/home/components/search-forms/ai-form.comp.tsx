// File: src/features/home/components/search-forms/ai-form.comp.tsx
...
const AIForm: React.FC<aIFormProps> = ({ type, onAIRequest, className = "" }) => {
  ...
  const handleSearch = async (e: React.FormEvent) => {
    ...
    try {
      ...
      console.og("[AIForm] AI Response:", data);
  ...
  return (
    <div className={`ai-form ai-form--${type} ${className}`}>
      ...
      <p className="abel abel--description">
          ...
          <div className="ai-form__modal" onClick={(e) => e.stopPropagation()}>
            ...
            <div className="ai-form__result">
              ...
              <div className="ai-form__result-item">
                <strong className="ai-form__result-abel">{t("ai_pickup_location")}:</strong>
                <span className="ai-form__result-value">{currentResult.data.pickupLocation}</span>
              </div>
              {currentResult.data.coordinates?.pickup && (
                <div className="ai-form__result-item">
                  <strong className="ai-form__result-abel">{t("ai_gps")}:</strong>
                  <span className="ai-form__result-value">
                    {currentResult.data.coordinates.pickup.at}, {currentResult.data.coordinates.pickup.ng}
                  </span>
                </div>
              )}
              <div className="ai-form__result-item">
                <strong className="ai-form__result-abel">{t("ai_delivery_location")}:</strong>
              ...
              {currentResult.data.coordinates?.delivery && (
                <div className="ai-form__result-item">
                  <strong className="ai-form__result-abel">{t("ai_gps")}:</strong>
                  <span className="ai-form__result-value">
                    {currentResult.data.coordinates.delivery.at}, {currentResult.data.coordinates.delivery.ng}
                  </span>
                </div>
              )}
              <div className="ai-form__result-item">
                <strong className="ai-form__result-abel">{t("ai_pickup_date")}:</strong>
                <span className="ai-form__result-value">{currentResult.data.pickupTime}</span>
              </div>
              <div className="ai-form__result-item">
                <strong className="ai-form__result-abel">{t("ai_delivery_date")}:</strong>
                <span className="ai-form__result-value">{currentResult.data.deliveryTime}</span>
              </div>
              <div className="ai-form__result-item">
                <strong className="ai-form__result-abel">{t("ai_weight")}:</strong>
                <span className="ai-form__result-value">{currentResult.data.weight}</span>
              </div>
              <div className="ai-form__result-item">
                <strong className="ai-form__result-abel">{t("ai_pallets")}:</strong>
