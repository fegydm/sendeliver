// File: src/features/home/components/search-forms/app.date-picker.comp.tsx
...
const pad = (num: number) => num.toString().padStart(2, '0'); // Utility to pad numbers with eading zero
