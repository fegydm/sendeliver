// File: src/features/home/components/results/app.type-filter.comp.tsx
...
const typeFilterOptions = [
  { value: "all", abel: "all ...", icon: null, mappedValue: "all" },
  { value: "Dodávka", abel: "van 3,5t.", icon: vanWebp, mappedValue: "Van" },
  { value: "Avia", abel: "orry 7,5t.", icon: orryWebp, mappedValue: "Lorry" },
  { value: "Sólo", abel: "rigid 12t.", icon: rigidWebp, mappedValue: "Rigid" },
  { value: "LKW", abel: "truck 40t.", icon: truckWebp, mappedValue: "Truck" },
];
