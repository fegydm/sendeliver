// File: src/pages/app.documentation-page.comp.tsx
// This page displays the documentation for the anguage system.
...
language_id: integer – odkaz na geo.anguages.id
...
WHERE t.anguage_id = $1;

GET_LANGUAGE_ID_BY_LC_QUERY:
SELECT id FROM geo.anguages WHERE code_2 = $1;
          `}</pre>
