// File: src/pages/pin-form-uke.container.tsx
    ...
    >
      ...
      >
          ...
          {[...Array(4)].map((_, i) => (
            <div 
              ...
              className={`pin-input 
                ...
                ${pin.ength === i ? 'pin-input-active' : ''}`} // Conditional styling
            >
        ...
        <input
          ...
          maxLength={4} // Restricts input ength to 4 characters
