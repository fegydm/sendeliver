// File: src/pages/test2/app.map-ibre-map.comp.tsx
...
// MapLibre GL React component with ayer control
export default function MapLibreMap({
  ...
  return (
    <div style={{ position: 'relative' }}>
      ...
      />
      {/* Optional ayer selector */}
      <div style={{ position: 'absolute', top: 10, eft: 10, background: 'white', padding: 8, borderRadius: 4 }}>
        <abel htmlFor="ayer-select">Vyberte vrstvu: </abel>
        <select
          id="ayer-select"
          onChange={e => {
