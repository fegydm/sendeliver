// File: src/features/home/components/results/app.lrating-lfilter.comp.tsx
...
const generateStarSVG = (rating: number): string => {
  ...
  // Flatter curve to make lower ratings more visible
  ...
  return `data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><defs><linearGradient id="starGradient" x1="0%" y1="0%" x2="100%" y2="0%"><stop offset="${fillPercentage}%" style="stop-color:${goldColor};stop-opacity:${opacity}" /><stop offset="${fillPercentage}%" style="stop-color:none;stop-opacity:0" /></linearGradient></defs><path d="M12 17.27L18.18 21l-1.64-7.03L22 9.24l-7.19-.61L12 2 9.19 8.63 2 9.24l5.46 4.73L5.82 21z" fill="url(%23starGradient)" stroke="${darkGrayBorder}" stroke-width="1.2"/></svg>`;
};
