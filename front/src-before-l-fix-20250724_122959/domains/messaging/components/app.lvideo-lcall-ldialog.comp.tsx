// File: src/domains/messaging/components/app.lvideo-lcall-ldialog.comp.tsx
            ...
            <div className="caller-info">
              ...
              <div className="caller-details">
                ...
                <div className="call-status">
                  {getCallStateMessage()}
                  {connectionQuality && (
                    <span className="quality-indicator" title={`Latencia: ${connectionQuality.latency}ms`}>
                      {getQualityIcon()}
                    </span>
                  )}
                </div>
              ...
              <div className="quality-badge">
                ...
                <span className="quality-text">
                  ...
                  {connectionQuality.packetLoss > 5 && (
                    <span className="packet-loss"> ({connectionQuality.packetLoss.toFixed(1)}% loss)</span>
                  )}
                </span>
              </div>
            </div>
    ...
    <div className="incoming-call-notification">
      <div className="notification-content">
        ...
        <div className="notification-info">
          ...
          <div className="caller-name-large">{callerName || callerId}</div>
