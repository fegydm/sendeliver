...
export const SEARCH_CONSTANTS = {
  MAX_DISTANCE_KM: 300, // Maximum distance for vehicle search in kilometers (sync with backend)
  ...
  AVAILABILITY_OFFSET_HOURS: 1, // Offset for availability_dt (delivery_dt + 1h)
} as const;