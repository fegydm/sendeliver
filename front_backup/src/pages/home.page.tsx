 ...
 return (
   <div className={`min-w-[320px] ${isDarkMode ? "dark bg-gray-900 text-white" : "bg-white text-gray-900"}`}>
     ...
     <div className="pt-16">
       ...
       {isAIChatOpen && (
         <div className="fixed inset-0 z-50 overflow-hidden">
           <div className="absolute inset-0 bg-black/50">
             <div className="container mx-auto px-4 py-8 h-full flex items-start">
               <div className={`w-full bg-white dark:bg-gray-800 rounded-lg shadow-xl h-[calc(100vh-160px)] ${
       ...
       <main className={`container mx-auto px-4 py-8 ${isAIChatOpen ? 'pointer-events-none' : ''}`}>
         <div className="grid md:grid-cols-2 gap-6">
           ...
           <ContentSection
             ...
             showStats={false}
           >
             <div className={`space-y-6 ${isAIChatOpen && activeSection !== "sender" ? "opacity-30 blur-sm" : ""}`}>
               <AiSearch
                 type="client"
           ...
           <ContentSection
             ...
             showStats={false}
           >
             <div className={`space-y-6 ${isAIChatOpen && activeSection !== "carrier" ? "opacity-30 blur-sm" : ""}`}>
               <AiSearch
                 type="carrier"
         ...
         {/* Quick Stats */}
         <div className={`mt-8 grid grid-cols-1 md:grid-cols-3 gap-6 ${isAIChatOpen ? "opacity-30 blur-sm" : ""}`}>
           <div className={`p-6 rounded-lg shadow-md ${isDarkMode ? "bg-gray-800" : "bg-gray-50"}`}>
